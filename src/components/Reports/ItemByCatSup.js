...
export default function ItemByCatSup() {
    ...
    return (
        <>
            <Box display="flex" justifyContent="center" alignItems="center" >
                ...
                <Button component = {RouterLink} to = {'/dashboard/reportsSup'} variant = 'contained' align="center" startIcon = {<Iconify icon = 'eva:arrow-back-fill'/>} sx = {{ ml: 1, height: 55}}>
                    Regresar
                </Button>
